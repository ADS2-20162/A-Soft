...
//==================================
    ...
    .state("ui.test1", {
        ...
        templateUrl: "americas_web_apps/ui/views/tests/test1.html",
        resolve: {
    ...
    .state("ui.test2", {
        url: "/test2",
        data: { page: 'Test 2' },
        templateUrl: "americas_web_apps/ui/views/tests/test2.html",
        resolve: {
            //checkSecurity: checkSecurity,
        },
        settings: {
    ...
    .state("ui.test3", {
        url: "/test3",
        data: { page: 'Test 3' },
        templateUrl: "americas_web_apps/ui/views/tests/test3.html"
    })
