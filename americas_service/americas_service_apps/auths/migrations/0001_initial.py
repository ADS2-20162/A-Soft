...
import americas_service_apps.auths.managers.UserManager
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', americas_service_apps.auths.managers.UserManager.UserManager()),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('genero', models.CharField(choices=[('M', 'Masculino'), ('F', 'Femenino')], max_length=40)),
                ('documento', models.CharField(help_text='documento nacional de identidad', max_length=8, unique=True, verbose_name='Identificacion')),
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True, verbose_name='updated at')),
                ('registered_by', models.TextField(blank=True, null=True)),
                ('tipo_documento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auths.DocumentoIdentidad')),
            ],
            options={
